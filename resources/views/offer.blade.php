            ...
            <div class="container flex justify-center mt-10">
                <div class="w-full mx-auto text-center">
                    <form action="/offer" method="post">
                        ...
                        @error('offer')<div class="text-alert">{{ $message }}</div>@enderror
                        <div class="pb-10">
                            <textarea placeholder="Opis budynku" class="@error('text1') border-alert @enderror border-form-stroke text-body-color placeholder-body-color focus:border-primary active:border-primary rounded-lg border-[1.5px] py-3 px-5 font-medium outline-none transition disabled:cursor-default disabled:bg-[#F5F7FD] h-96 w-1/2" name="description" />{{ $offer->text1 }}</textarea>
                        </div>

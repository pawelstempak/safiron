<!-- ====== Modal Section Start -->
  ...
  >
    <div
      @click.outside="modalImage{{$id}} = false"
      class="w-full max-w-[1000px] rounded-[20px] bg-white py-12 px-8 text-right md:py-[60px] md:px-[70px]"
    >
      <div class="relative">
      <img src="{{$url}}">
        <p @click="modalImage{{$id}} = false" class="cursor-pointer absolute top-2 right-2">

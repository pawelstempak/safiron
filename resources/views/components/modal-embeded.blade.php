...
<div
  ...
  >
    <div
      @click.outside="modalEmbeded{{$id}} = false"
      class="w-full max-w-[1500px] h-full rounded-[20px] bg-white py-12 px-8 text-right md:py-[60px] md:px-[70px]"
    >
      <div class="relative h-full">
        <p @click="modalEmbeded{{$id}} = false" class="cursor-pointer absolute -top-10 right-0">
        ...
        <embed src="{{$url}}" type="application/pdf" class="w-full h-full"></embed>
      </div>
    </div>
  </div>
<!-- ====== Modal Section End -->
      ...
      <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
        <div class="mb-10 w-full">
          ...
          <div class="mb-6 flex items-center">
            <a href="javascript:void(0)" class="text-sand hover:bg-sand/50 hover:border-sand/50 mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">

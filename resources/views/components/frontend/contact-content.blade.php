...
<div class="relative shadow-2xl">
  <img src="/images/contact.jpg" class="hidden md:block" />
  <img src="/images/contact_md.jpg" class="md:hidden" />
</div>
    ...
    <div class="xl:mx-20 flex flex-wrap lg:justify-between">
      <div class="w-full lg:w-1/2 md:px-10">
        ...
        @endif
          ...
          <h2 class="text-primary mb-6 font-bold font-exo uppercase text-[24px] sm:text-[28px] lg:text-[30px] border-2 border-x-0 border-t-0 border-b-secondary">
            MASZ DO NAS PYTANIE?
          </h2>
          <p class="text-body-color mb-9 text-base leading-relaxed">
            Jeżeli masz pytanie, wątpliwości - napisz do nas.<br>Skontaktujemy się z Tobą i odpowiemy na wszystkie pytania.
          </p>
      ...
      <div class="w-full lg:w-1/2 md:px-10">
        ...
        <div class="mb-8 flex w-full max-w-[370px]">
          <div class="border border-primary/75 text-primary mt-1 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
          ...
          <div class="w-full">
            <h4 class="text-dark mb-1 text-xl font-bold">Biuro sprzedaży</h4>
            <p class="text-slate-600 text-base">
              37-100 Łańcut<br>
              Wola Dalsza 369 (I piętro)
            </p>
          </div>
        </div>
        <div class="mb-8 flex w-full max-w-[370px]">
          <div class="border border-primary/75 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
          ...
          <div class="w-full">
            ...
            <a href="tel:+48 512 280 900" class="text-slate-600 text-base underline hover:text-secondary">+48 512 280 900</a>
          </div>
        </div>
        <div class="mb-8 flex w-full max-w-[370px]">
          <div class="border border-primary/75 text-primary mt-1 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
          ...
          <div class="w-full">
            ...
            <a href="mail:sprzedaz@noweprzedmiescie.pl" class="text-slate-600 text-base underline hover:text-secondary">sprzedaz@noweprzedmiescie.pl</a>
            <a href="mail:s.swieboda@noweprzedmiescie.pl" class="text-slate-600 text-base underline hover:text-secondary">s.swieboda@noweprzedmiescie.pl</a>
          </div>
        </div>
      </div>
    </div>

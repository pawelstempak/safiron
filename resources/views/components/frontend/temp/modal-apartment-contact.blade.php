    ...
    >
      <div class="relative">
       <p @click="modalApartmentContact{{$id}} = false" class="cursor-pointer absolute top-0 right-0">
        ...
        <br><br>
        <div class="px-20 text-2xl text-primary font-semibold pt-5 pb-2 mb-5 text-center">Wyślij zapytanie</div>
        ...
        <div class="px-20">
          <form>
            ...
            <div class="mb-6">
              <textarea
                rows="6"
                placeholder="Napisz o co chesz zapytać"

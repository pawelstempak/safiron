              <div x-data="{ navbarOpen: false }" class="my-10 xl:my-0">
                ...
                <nav :class="!navbarOpen && 'hidden' " id="navbarCollapse" class="absolute right-4 top-full w-full max-w-[300px] bg-white xl:bg-transparent rounded-lg py-5 px-6 shadow xl:static xl:block xl:w-full xl:max-w-full xl:shadow-none z-50">
